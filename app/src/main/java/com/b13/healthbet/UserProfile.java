...
public class UserProfile extends AppCompatActivity {
    ...
    private void updateUserProfile() {
        ...
        if (user != null) {
            ...
            float weigth = Float.parseFloat(this.weightField.getText().toString());
            float height = Float.parseFloat(this.heightField.getText().toString());
            float age = Float.parseFloat(this.ageField.getText().toString());
            ...
            if (weigth > 150 && weigth < 0) {
                Toast.makeText(this, "Weight should be less than 150", Toast.LENGTH_LONG).show();
                return;
            }

            if (height > 150 && height < 0) {
                Toast.makeText(this, "Height should be less than 150", Toast.LENGTH_LONG).show();
                return;
            }

            if (age > 150 && age < 0) {
                Toast.makeText(this, "You age doesn't supported", Toast.LENGTH_LONG).show();
                return;
            }

            try {
                userData.put("weight", weigth);
